...
----------------------------------------------------------------------------------
--Command: generate_target bd_94d8_wrapper.bd
--Design : bd_94d8_wrapper
...
architecture STRUCTURE of bd_94d8_wrapper is
  component bd_94d8 is
  port (
    Clk : in STD_LOGIC;
    Reset : in STD_LOGIC;
    TRACE_data_access : out STD_LOGIC;
  ...
  end component bd_94d8;
begin
bd_94d8_i: component bd_94d8
     port map (
      Clk => Clk,
