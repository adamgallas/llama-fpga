...
----------------------------------------------------------------------------------
--Command: generate_target bd_e69a_wrapper.bd
--Design : bd_e69a_wrapper
...
architecture STRUCTURE of bd_e69a_wrapper is
  component bd_e69a is
  port (
    Clk : in STD_LOGIC;
    Reset : in STD_LOGIC;
    TRACE_data_access : out STD_LOGIC;
  ...
  end component bd_e69a;
begin
bd_e69a_i: component bd_e69a
     port map (
      Clk => Clk,
