...
----------------------------------------------------------------------------------
--Command: generate_target bd_4b5b_wrapper.bd
--Design : bd_4b5b_wrapper
...
architecture STRUCTURE of bd_4b5b_wrapper is
  component bd_4b5b is
  port (
    Clk : in STD_LOGIC;
    Reset : in STD_LOGIC;
    TRACE_data_access : out STD_LOGIC;
  ...
  end component bd_4b5b;
begin
bd_4b5b_i: component bd_4b5b
     port map (
      Clk => Clk,
