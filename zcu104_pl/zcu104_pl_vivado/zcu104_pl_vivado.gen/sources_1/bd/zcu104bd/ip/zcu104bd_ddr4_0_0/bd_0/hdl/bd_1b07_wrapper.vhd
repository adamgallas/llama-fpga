...
----------------------------------------------------------------------------------
--Command: generate_target bd_1b07_wrapper.bd
--Design : bd_1b07_wrapper
...
architecture STRUCTURE of bd_1b07_wrapper is
  component bd_1b07 is
  port (
    Clk : in STD_LOGIC;
    Reset : in STD_LOGIC;
    TRACE_data_access : out STD_LOGIC;
  ...
  end component bd_1b07;
begin
bd_1b07_i: component bd_1b07
     port map (
      Clk => Clk,
