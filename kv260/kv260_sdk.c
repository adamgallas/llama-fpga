...
#define first_bank 2109472768
#define second_bank 1915437056
//#define first_bank 2099970048
//#define second_bank 1905930240
#define EDGELLM_BASE_ADDR 0x1000000000
/*
...
//	printf("global_vocab: 0x%lx\n", (u64)(global_vocab));
//	printf("global_sort_vocab: 0x%lx\n", (u64)(global_sort_vocab));
//	printf("global_vocab_scores: 0x%lx\n", (u64)(global_vocab_scores));
//	printf("str_buffer: 0x%lx\n", (u64)(str_buffer));
//	printf("vocab_space: 0x%lx\n", (u64)(vocab_space));
//	printf("prompt_tokens: 0x%lx\n", (u64)(prompt_tokens));
//	printf("prompt: 0x%lx\n", (u64)(prompt));
