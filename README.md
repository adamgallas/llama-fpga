...
* **[TeLLMe](https://arxiv.org/abs/2504.16266)** and **[TeLLMe v2](https://arxiv.org/abs/2510.15926)** — these works focus on **KV260** for LLM acceleration. They target **both prefill and decode phases**, solving the **prefill speed bottleneck** and achieving efficient end-to-end ternary LLM acceleration.
